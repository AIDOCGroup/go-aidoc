...
func TestUnmarshalPubkey(t *testing.T) {
	...
	if err != errInvalidPubkey || key != nil {
		t.Fatalf("expected error, 得到 %v, %v", err, key)
	}
...
func TestSign(t *testing.T) {
	...
	addr := chain_common.HexToAddress(testAddrHex)
...
func TestNewContractAddress(t *testing.T) {
	...
	checkAddr(t, chain_common.HexToAddress("333c3310824b7c685133f2bedb2ca4b8b4df633d"), caddr0)
	checkAddr(t, chain_common.HexToAddress("8bda78331c916a08481428e4b07c96d3e916d165"), caddr1)
	checkAddr(t, chain_common.HexToAddress("c9ddedf451bc62ce88bf9292afb13df35b670699"), caddr2)
}

func TestLoadECDSAFile(t *testing.T) {
	keyBytes := chain_common.FromHex(testPrivHex)
	fileName0 := "test_key0"
	fileName1 := "test_key1"
	checkKey := func(k *ecdsa.PrivateKey) {
		checkAddr(t, PubkeyToAddress(k.PublicKey), chain_common.HexToAddress(testAddrHex))
...
func TestValidateSignatureValues(t *testing.T) {
	...
	one := chain_common.Big1
	zero := chain_common.Big0
	secp256k1nMinus1 := new(big.Int).Sub(secp256k1N, chain_common.Big1)
...
func checkAddr(t *testing.T, addr0, addr1 chain_common.Address) {
	if addr0 != addr1 {
...
func TestPythonIntegration(t *testing.T) {
	...
	msg1 := chain_common.FromHex("00000000000000000000000000000000")
	sig1, _ := Sign(msg0, k0)
