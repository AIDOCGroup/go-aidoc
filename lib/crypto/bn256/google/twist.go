...
// twistPoint 在 GF(p²) 上实现椭圆曲线 y²=x³+3/ξ。
// 当有效时，点以雅可比形式保持，t =z²。
// G₂ 组是 GF(p²) 上该曲线的n-扭转点的集合（其中n =顺序）
...
func (c *twistPoint) Double(a *twistPoint, pool *bnPool) {
	// 见 http://hyperelliptic.org/EFD/g1p/auto-code/shortw/jacobian-0/doubling/dbl-2009-l.op3
