...
// curvePoint 实现椭圆曲线 y² = x³ + 3。
// 当有效时，点以雅可比形式保持，t =z²。 G₁ 是 GF(p) 上该曲线的一组点。
...
// IsOnCurve 返回 true 如果 ifc 在曲线上，其中 c 必须是仿射形式。
...
func (c *curvePoint) Add(a, b *curvePoint, pool *bnPool) {
	...
	//见http://hyperelliptic.org/EFD/g1p/auto-code/shortw/jacobian-0/addition/add-2007-bl.op3

	// 通过替换a = [x1：y1：z1]和b = [x2：y2：z2]来标准化点
	// by [u1：s1：z1·z2]和[u2：s2：z1·z2]
	// 其中u1 = x1·z2²，s1 = y1·z2³和u1 = x2·z1²，s2 = y2·z1³
...
func (c *curvePoint) Double(a *curvePoint, pool *bnPool) {
	// 见http://hyperelliptic.org/EFD/g1p/auto-code/shortw/jacobian-0/doubling/dbl-2009-l.op3
